...
const (
	...
	User_BindUserIdWithClientId_FullMethodName       = "/OpenIMServer.user.user/bindUserIdWithClientId"
	User_UnBindUserIdWithClientId_FullMethodName     = "/OpenIMServer.user.user/unBindUserIdWithClientId"
)
...
type UserClient interface {
	...
	//bindUserIdWithClientId
	BindUserIdWithClientId(ctx context.Context, in *BindUserIdWithClientIdReq, opts ...grpc.CallOption) (*BindUserIdWithClientIdResp, error)
	//unbindUserIdWithClientId
	UnBindUserIdWithClientId(ctx context.Context, in *UnBindUserIdWithClientIdReq, opts ...grpc.CallOption) (*UnBindUserIdWithClientIdResp, error)
}
...
func (c *userClient) BindUserIdWithClientId(ctx context.Context, in *BindUserIdWithClientIdReq, opts ...grpc.CallOption) (*BindUserIdWithClientIdResp, error) {
	out := new(BindUserIdWithClientIdResp)
	err := c.cc.Invoke(ctx, User_BindUserIdWithClientId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) UnBindUserIdWithClientId(ctx context.Context, in *UnBindUserIdWithClientIdReq, opts ...grpc.CallOption) (*UnBindUserIdWithClientIdResp, error) {
	out := new(UnBindUserIdWithClientIdResp)
	err := c.cc.Invoke(ctx, User_UnBindUserIdWithClientId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	//bindUserIdWithClientId
	BindUserIdWithClientId(context.Context, *BindUserIdWithClientIdReq) (*BindUserIdWithClientIdResp, error)
	//unbindUserIdWithClientId
	UnBindUserIdWithClientId(context.Context, *UnBindUserIdWithClientIdReq) (*UnBindUserIdWithClientIdResp, error)
...
func (UnimplementedUserServer) BindUserIdWithClientId(context.Context, *BindUserIdWithClientIdReq) (*BindUserIdWithClientIdResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BindUserIdWithClientId not implemented")
}
func (UnimplementedUserServer) UnBindUserIdWithClientId(context.Context, *UnBindUserIdWithClientIdReq) (*UnBindUserIdWithClientIdResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnBindUserIdWithClientId not implemented")
}
...
func _User_BindUserIdWithClientId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BindUserIdWithClientIdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).BindUserIdWithClientId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_BindUserIdWithClientId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).BindUserIdWithClientId(ctx, req.(*BindUserIdWithClientIdReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _User_UnBindUserIdWithClientId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnBindUserIdWithClientIdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).UnBindUserIdWithClientId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_UnBindUserIdWithClientId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UnBindUserIdWithClientId(ctx, req.(*UnBindUserIdWithClientIdReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "bindUserIdWithClientId",
			Handler:    _User_BindUserIdWithClientId_Handler,
		},
		{
			MethodName: "unBindUserIdWithClientId",
			Handler:    _User_UnBindUserIdWithClientId_Handler,
		},
	},
